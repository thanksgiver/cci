...
/* themes/eva/templates/navigation/menu-local-tasks.html.twig */
class __TwigTemplate_9e784bbdb6cae74de69cd2ffdaec1362f6a254ccb0a800bed0f2d1afc9f58183 extends Twig_Template
{
...
";
    ...
    {
        return "themes/eva/templates/navigation/menu-local-tasks.html.twig";
    }
...
#}
{% if primary %}
  <h2 class=\"invisible\">{{ 'Primary tabs'|t }}</h2>
  <div class=\"btn-group py-3\" role=\"group\">{{ primary }}</div>
{% endif %}
{% if secondary %}
  <h2 class=\"invisible\">{{ 'Secondary tabs'|t }}</h2>
  <div class=\"btn-group py-3\" role=\"group\">{{ secondary }}</div>
{% endif %}
", "themes/eva/templates/navigation/menu-local-tasks.html.twig", "/Volumes/DATA-01/03-WEBSITE/cci/themes/eva/templates/navigation/menu-local-tasks.html.twig");
    }
}
