...
/* themes/joy/templates/navigation/links--node.html.twig */
class __TwigTemplate_c998feff9031834ccd2b9713f0c3284edf7b330888ed099cb157a128fc8cf7a3 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (($context["links"] ?? null)) {
            ...
            // line 44
            echo "<div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "addClass", array(0 => "control-links"), "method"), "html", null, true));
            echo ">";
            // line 45
    ...
    {
        return "themes/joy/templates/navigation/links--node.html.twig";
    }
    ...
    {
        return array (  84 => 50,  77 => 47,  75 => 46,  71 => 45,  67 => 44,  59 => 41,  49 => 39,  47 => 38,  45 => 37,  43 => 36,);
    }
...
{% if links -%}
  {%- if heading -%}
    ...
    {%- endif -%}
  {%- endif -%}
  <div{{ attributes.addClass('control-links') }}>
    {%- for item in links -%}
        {%- if item.link -%}
          {{ item.link }}
        {%- endif -%}
...
{%- endif %}
", "themes/joy/templates/navigation/links--node.html.twig", "/Volumes/Websites/cci/themes/joy/templates/navigation/links--node.html.twig");
    }
}
