...
/* themes/eva/templates/misc/status-messages.html.twig */
class __TwigTemplate_e746a2b215b96117c7db8110993d5adf063accf3dfc023d12e2b5a637a50318a extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
            ...
            echo "\"";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(twig_without(($context["attributes"] ?? null), "role", "aria-label"), "addClass", array(0 => "alert alert-success"), "method"), "html", null, true));
            echo ">
    ";
            // line 26
...
";
    ...
    {
        return "themes/eva/templates/misc/status-messages.html.twig";
    }
...
{% for type, messages in message_list %}
  <div role=\"contentinfo\" aria-label=\"{{ status_headings[type] }}\"{{ attributes|without('role', 'aria-label').addClass('alert alert-success') }}>
    {% if type == 'error' %}
      <div role=\"alert\">
    {% endif %}
...
{% endfor %}
", "themes/eva/templates/misc/status-messages.html.twig", "/Volumes/Websites/cci/themes/eva/templates/misc/status-messages.html.twig");
    }
}
